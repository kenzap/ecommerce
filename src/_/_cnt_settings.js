              ...
              <div class="card border-white shadow-sm p-sm-3 ">
                ...
                <div class="card-body tab-content" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-notifications" role="tabpanel" aria-labelledby="nav-notifications-link">
                    ...
                    <h4 id="h-orders" class="card-title mb-4">${__('Orders')}</h4>
                    <div class="row">
                      <div class="col-lg-6">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                          <label class="col-sm-3 col-form-label">${__('Tables')}</label>
                          <div class="col-sm-9">
                            ...
                            <p class="form-text">${__('Enable table mode in orders dashboard.')}</p>
                          </div> 
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                          <label class="col-sm-3 col-form-label">${__('List of tables')}</label>
                          <div class="col-sm-9">
                            ...
                            <p class="form-text">${__('Provide one table per line. Example: 5.')}</p>
                          </div> 
                        </div>
                      </div>
                    </div>
                    
                    <h4 id="h-notifications" class="card-title mb-4 mt-4">${__('Notifications')}</h4>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                    ...
                    <h4 id="h-currency" class="card-title mb-4 mt-4">${__('Currency')}</h4>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                    ...
                    <h4 id="h-tax" class="card-title mb-4 mt-4">${__('Tax')}</h4>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                    ...
                    <h4 id="h-fees" class="card-title mb-4 mt-4">${__('Fees')}</h4>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                    ...
                    <h4 id="h-payment" class="card-title mb-4 mt-4">${__('Payment')}</h4>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                          <label class="col-sm-3 col-form-label">${__('Methods')}</label>
                          <div class="col-sm-9">
                            <div class="form-check">
                            ...
                            <p class="form-text">${__('Allow changing of payment method in the dashboard.')}</p>
                          </div> 
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                          <label class="col-sm-3 col-form-label">${__('List of Methods')}</label>
                          <div class="col-sm-9">
                            ...
                            <p class="form-text">${__('Provide list of available payment methods. Example: PayPal, PayNow.')}</p>
                          </div> 
                        </div>
                      </div>
                    </div>

                    <h4 id="h-discounts" class="card-title mb-4 mt-4">${__('Discounts')}</h4>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                    ...
                    <h4 id="h-printing" class="card-title mb-4 mt-4">${__('Printing')}</h4>
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group row mb-3 mt-1">
                    ...
                    <h4 id="h-tax" class="card-title mb-4">${__('Your tax information')}</h4>
                    ...
                    <h4 id="h-payout" class="card-title mb-4" title="payouts">${__('Payout data')}</h4>
